...
export const SEED_EXERCISES: ExerciseSeed[] = [
  ...
  { name: 'Skull Crusher', category: ExerciseCategory.Strength, primaryMuscles: [MuscleGroup.Triceps], equipment: Equipment.Barbell, instructions: 'Lie on a bench, lower an EZ/straight bar to the forehead by bending elbows, extend back up.' },
  { name: 'Russian Twist', category: ExerciseCategory.Strength, primaryMuscles: [MuscleGroup.Core], equipment: Equipment.Bodyweight, instructions: 'Sit leaning back, feet off the floor, rotate torso side to side.' },
  { name: 'Trap Bar Deadlift', category: ExerciseCategory.Strength, primaryMuscles: [MuscleGroup.Back, MuscleGroup.Hamstrings, MuscleGroup.Glutes], equipment: Equipment.Barbell, instructions: 'Stand inside the trap bar, grip handles, drive through heels and extend hips and knees.' },
  { name: 'Dumbbell Reverse Lunge', category: ExerciseCategory.Strength, primaryMuscles: [MuscleGroup.Quads, MuscleGroup.Glutes], equipment: Equipment.Dumbbell, instructions: 'Hold dumbbells, step one foot back into a lunge, drive through the front heel to stand.' },
  { name: 'Dumbbell Reverse Fly', category: ExerciseCategory.Strength, primaryMuscles: [MuscleGroup.RearDelt], equipment: Equipment.Dumbbell, instructions: 'Hinge forward, raise dumbbells out to the sides squeezing rear delts, lower slowly.' },
  { name: 'Front Squat', category: ExerciseCategory.Strength, primaryMuscles: [MuscleGroup.Quads, MuscleGroup.Glutes], equipment: Equipment.Barbell, instructions: 'Bar racked on front delts, squat down keeping torso upright, drive up.' },
  { name: 'Good Morning', category: ExerciseCategory.Strength, primaryMuscles: [MuscleGroup.Hamstrings, MuscleGroup.Glutes], equipment: Equipment.Barbell, instructions: 'Bar on upper back, hinge at the hips with a slight knee bend, return to standing.' },
  { name: 'Hack Squat', category: ExerciseCategory.Strength, primaryMuscles: [MuscleGroup.Quads, MuscleGroup.Glutes], equipment: Equipment.Machine, instructions: 'Shoulders under the pads, lower into a squat, press through the platform to stand.' },
];
